...
class CompleteWorkerRegistrationScreen extends StatefulWidget {
  ...
  @override
  State<CompleteWorkerRegistrationScreen> createState() => _CompleteWorkerRegistrationScreenState();
}

class _CompleteWorkerRegistrationScreenState extends State<CompleteWorkerRegistrationScreen> {
                    ...
                    Expanded(
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final isSelected = _selectedServiceIds.contains(category.id);
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Checkbox(
                                      value: isSelected,
                                      onChanged: (value) => _toggleServiceSelection(category.id),
